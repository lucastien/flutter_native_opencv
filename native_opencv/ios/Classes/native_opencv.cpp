...
extern "C"
{
    ...
    __attribute__((visibility("default"))) __attribute__((used))
    void align_images(char *imgPath, char *templatePath, char *alignedImgPath)
    {
        Mat im1 = imread(imgPath, IMREAD_GRAYSCALE);
        Mat im2 = imread(templatePath, IMREAD_GRAYSCALE);
        Mat im1Reg, h;
        // Convert images to grayscale
        Mat im1Gray, im2Gray;
        cvtColor(im1, im1Gray, COLOR_GRAY2BGR);
        cvtColor(im2, im2Gray, COLOR_GRAY2BGR);
